      ...
      <div className="grid md:grid-cols-3 ">
        {currentItems
          ...
          .map((item) => (
            <div
              key={item.id}
              className="hover:-translate-y-6 ease-in duration-300 "
            >
              <div
                className={`bg-slate-200 text-black  m-5 rounded-lg shadow-lg ${
                  editingItemId === item.id ? "border-2 border-blue-500" : ""
                }`}
              >
                <div className="grid grid-cols-2">
                  <BsFillPinAngleFill
                  data-tooltip-id="pintoTop"
                    className={`text-4xl hover:rotate-12 focus:outline-none ${
                ...
                {editingItemId === item.id ? (
                  ...
                  <>
                    ...
                    <div className="flex">
                      {item.tag ? (
                        <p className="p-1 bg-sky-800 rounded-xl text-xs text-white m-1  uppercase ">
                          {item.tag}
                        </p>
                      ) : null}
                    </div>
                    ...
                    <div className="grid grid-cols-2 justyfy-items-center border-t-2 border-black">
                      <button
                        ...
                        onClick={() =>
                          startEditing(item.id, item.title, item.body)
                        }
                      >
                        <center>
                          <GrEdit />
                      ...
                      <button
                        className="p-1 bg-red-400 align-center"
